...
/*!
 * AVERITT's Change log
 * 3/31/2023 - JQUERY 3+ deprecated trigger and on envent shotcuts. Those are repalced with the .trigger() and .on() syntax
 * The original version was saved to pickadate.js.orig (you can performa diff to see the changes)
 */
            ...
            var
                ...
                P = Picker.prototype = {
                    ...
                    open: function() {
                        ...
                        $ELEMENT.trigger('focus').addClass( CLASSES.inputActive )
                ...
                $HOLDER = $( createNode( STRING_DIV, createCalendarWrapped(), CLASSES.holder ) ).on( 'mousedown', function( event ) {
                    ...
                    // * This needs to be after `$ELEMENT.trigger('focus')`
                    CALENDAR._IE = 1
                ...
                return [
                    ...
                    $findInHolder( CLASSES.selectMonth ).on({
                        ...
                        change: function() {
                            ...
                            $findInHolder( CLASSES.selectMonth ).trigger('focus')
                        }
                    })[ 0 ],
                    ...
                    $findInHolder( CLASSES.selectYear ).on({
                        ...
                        change: function() {
                            ...
                            $findInHolder( CLASSES.selectYear ).trigger('focus')
                        }
                    })[ 0 ],
